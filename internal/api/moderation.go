...
// BlockUser blocks the user with the given numeric user ID.
func (c *Client) BlockUser(userID string) error {
	vars := map[string]any{"target_user_id": userID}
...
// UnblockUser unblocks the user with the given numeric user ID.
...
// MuteUser mutes the user with the given numeric user ID.
...
// UnmuteUser unmutes the user with the given numeric user ID.
